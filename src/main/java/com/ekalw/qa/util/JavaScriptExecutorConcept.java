...
//NOTE: JUST COPY PASTED HERE AND NOT ADDED MEHTODS TO UTIL OR TESTBASE, So her u will find main method also..Do not run, just understand.
...
public class JavaScriptExecutorConcept extends TestBase {
    ...
    public static void selectDateByJS(WebDriver driver,WebElement element,String dateVal){
    	...
    	//call in main method as:- 
    	//String dateVal="30-12-2017"
    	//selectDateByJS(driver,data,dateVal);  //and date will be added Note but date not verified , wrong date may also enter so be careful
    }
